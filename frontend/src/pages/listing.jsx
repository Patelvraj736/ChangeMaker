...
const Listing = () => {
    ...
    useEffect(() => {
        axios.get(`${import.meta.env.VITE_API_URL}/api/ngos/categories`)
    ...
    useEffect(() => {
        if (selectedCategory && selectedCategory.id) {
            axios.get(`${import.meta.env.VITE_API_URL}/api/ngos/featured/${selectedCategory.id}`)
                .then((res) => {
            ...
            axios.get(`${import.meta.env.VITE_API_URL}/api/ngos/category/${selectedCategory.id}/ngos`)
